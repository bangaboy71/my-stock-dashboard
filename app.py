...
# --- [CSS: v30.8 스타일 완벽 유지 및 하이퍼링크 효과] ---
st.markdown("""
    <style>
...
with tabs[0]:
    ...
    # 🎯 [부실 리포트 해결] v30.8의 풍부한 리포트 내용 복원
